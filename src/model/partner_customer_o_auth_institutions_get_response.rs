...
use super::{
    PartnerEndCustomerFlowdownStatus, PartnerEndCustomerOAuthInstitution,
...
pub struct PartnerCustomerOAuthInstitutionsGetResponse {
    ...
    pub flowdown_status: Option<PartnerEndCustomerFlowdownStatus>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub questionnaire_status: Option<PartnerEndCustomerQuestionnaireStatus>,
