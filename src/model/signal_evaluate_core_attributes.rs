...
pub struct SignalEvaluateCoreAttributes {
    ...
    #[serde(rename = "distinct_ssl_tls_connection_sessions_count_30d")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub distinct_ssl_tls_connection_sessions_count30_d: Option<i64>,
    ...
    #[serde(rename = "distinct_ssl_tls_connection_sessions_count_3d")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub distinct_ssl_tls_connection_sessions_count3_d: Option<i64>,
    ...
    #[serde(rename = "distinct_ssl_tls_connection_sessions_count_7d")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub distinct_ssl_tls_connection_sessions_count7_d: Option<i64>,
    ...
    #[serde(rename = "distinct_ssl_tls_connection_sessions_count_90d")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub distinct_ssl_tls_connection_sessions_count90_d: Option<i64>,
