...
use super::{PayPeriodDetailsPayFrequency, PaystubOverrideDistributionBreakdown};
...
pub struct PaystubOverridePayPeriodDetails {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub distribution_breakdown: Option<Vec<PaystubOverrideDistributionBreakdown>>,
...
impl std::fmt::Display for PaystubOverridePayPeriodDetails {
