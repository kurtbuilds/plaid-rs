...
use super::{
    PaystubOverrideEmployee, PaystubOverrideEmployer, W2Box12Override,
    W2StateAndLocalWagesOverride,
};
///W2 is an object that represents income data taken from a W2 tax document.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct W2Override {
    ///Allocated tips.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub allocated_tips: Option<String>,
    #[serde(rename = "box_12")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub box12: Option<Vec<W2Box12Override>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state_and_local_wages: Option<Vec<W2StateAndLocalWagesOverride>>,
    ///Statutory employee.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl std::fmt::Display for W2Override {
